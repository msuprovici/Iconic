...
- (void)objectsDidLoad:(NSError *)error {
    ...
    for (PFObject *object in self.objects) {
        ...
        NSMutableArray *objectsInSection = [self.teams objectForKey:teamMatchup];
        if (!objectsInSection) {
        ...
        [self.teams setObject:objectsInSection forKey:teamMatchup];
    }
...
- (PFObject *)objectAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSArray *rowIndecesInSection = [self.teams objectForKey:teamMatchups];
