...
- (void)customizeAppearance
{
    ...
    [[UINavigationBar appearance] setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"DIN Alternate" size:17], NSFontAttributeName, nil]];
