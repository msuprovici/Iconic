        ...
        if(CreateUserName.text!.characters.count > 3)
        {
            ...
            if (error == nil) {
                ...
                if(objects!.count >= 1)
                {
                    ...
                    let alert = UIAlertController(title: "Username taken", message: "Please enter a new username.", preferredStyle: UIAlertControllerStyle.Alert)
...
//                }
        ...
        {
            let alert = UIAlertController(title: "Username should be at least 4 characters", message: "Please enter a new username.", preferredStyle: UIAlertControllerStyle.Alert)
